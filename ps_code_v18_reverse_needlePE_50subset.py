...
def filter_sample(f_name,pe_name,template,f_filt_seqs,r_filt_seqs):
        ...
        f_seqs3 = f_seqs2[0]
        f_seqs4 = f_seqs3[0:10000]
        # Repeat for paired-end reads

        pe_seqs3 = pe_seqs2[2]
        pe_seqs4 = pe_seqs3[0:10000]
        ...
        # make temp sequence file for alignment, hopefully re-written every time
                ...
                if filt_seq not in str(s.seq): #if the scar isn't found on the forward read 
                    ...
                    if match_len < 12:
                        ...
                        bar3  = re.search((Seq(search_oligo).reverse_complement()),str(pe_seqs[p_index])) #find the aligned region's reverse complement in the actual PE sequence
                        bar4 = re.search((Seq(filt_seq).reverse_complement()),str(pe_seqs[p_index])) # find the filt sequence's reverse complement (in this case the scar) in the actual PE sequence
