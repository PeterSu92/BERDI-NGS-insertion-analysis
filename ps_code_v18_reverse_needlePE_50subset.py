...
def filter_sample(f_name,pe_name,template,f_filt_seqs,r_filt_seqs):
        ...
        f_seqs3 = f_seqs2[0]
        f_seqs4 = f_seqs3[0:49]
        # Repeat for paired-end reads

        pe_seqs3 = pe_seqs2[2]
        pe_seqs4 = pe_seqs3[0:49]
        ...
        # make temp sequence file for alignment, hopefully re-written every time
                ...
                if filt_seq not in str(s.seq): #if the scar isn't found on the forward read 
                    ...
                    if match_len < 17:
                        ...
                        bar4 = re.search(Seq(filt_seq).reverse_complement(),pe_seqs[p_index]) # find the filt sequence's reverse complement (in this case the scar) in the actual PE sequence
